...
# 14 "../include/x-socket.h" 2
# 24 "../include/x-socket.h"
...
# 23 "select.cpp"
        ...
        psockaddr->sin_addr.s_addr = htonl(
# 24 "select.cpp" 3 4
...
# 45 "select.cpp"
    ...
    if(lfd==1){perror("create socket");exit(1);};

    ret = bind_sockaddr(lfd,9999,
# 49 "select.cpp" 3 4
                                       __null
# 49 "select.cpp"
                                           ,&server_sockaddr);
